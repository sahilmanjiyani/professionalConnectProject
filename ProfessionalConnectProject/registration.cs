       ...
       // EditText myfname, mylname, myuserid, mypass, myphone, myrole;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
         ...
         // inserting values to the reg table 
           /* myuserDBHelper.insertValue("vandana","R","v@mail.com","1234",0344,"Student");
            myuserDBHelper.insertValue("Sahil", "M", "S@mail.com", "12345",0455, "Employer");
            myuserDBHelper.insertValue("Sandarbh", "MS", "MS@mail.com", "123456",0211, "Employer");*/
